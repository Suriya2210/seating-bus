...
const UserBookHistory = () => {
  ...
  const handleConfirmCancel = (booking) => {
    const json_body = {
      ...
      cancellation_reason: selectedOption === 'Other' ? remarks : selectedOption
    };
    axios
        ...
        <div className="popup-container">
          <div className="popup">
            ...
            <div className="popup-button">
              <button className="confirm-btn" onClick={() => handleConfirmCancel(booking)}>Confirm</button>
